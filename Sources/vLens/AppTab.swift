...
enum AppTab: String, CaseIterable, Identifiable {
    case vInfo, vCpu, vMemory, vDisk, vSnapshot, vTools, vNetwork, vCD, vUSB, vPartition, vPerformance
    ...
    var group: AppTabGroup {
        switch self {
        case .vInfo, .vCpu, .vMemory, .vDisk, .vSnapshot, .vTools, .vNetwork, .vCD, .vUSB, .vPartition, .vPerformance: return .vm
